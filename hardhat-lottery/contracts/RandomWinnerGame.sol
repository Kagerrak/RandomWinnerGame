...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    uint256 public fee;
    // ID of public key agaisnt which randomness is generated
    ...
    uint8 maxPlayers;
    // Variable to inidcate if game has started or not
    ...
    // emitted when someine joins a game
     ...
     * @param vrfCoordinator address of BRFCoordinator contract
     * @param linkToken address of LINK token contract
     * @param vrfFee the amount of LINK to send with the request
     * @param vrfKeyHash ID of public key agaisnt which randomness is generated
     */
    constructor(
    ...
    /**
     * fullfillRandomness is called by the VRFCoordinator when it receives a valid VRF proof.
     * This function is overridden to act upon the random number generated by the Chainlink VRF.
     * @param requestId  this ID is unique for the request we sent to the VRFCoordinator
     * @param randomness this is a random uint256 generated and returned to is by the VRFCoordinator
     */
        ...
        override
    {
        ...
        // send the ether in hte contract to the winner
        (bool sent, ) = winner.call{value: address(this).balance}("");
        require(sent, "Failed to send Ether");
        // Emit that hte games has ended
    ...
    function getRandomWinner() private returns (bytes32 requestId) {
        // LINK is an internal unterface for link token found within the VRFConsumerBase
        // Here we use hte balanceOf method from that interface to make sure that our
